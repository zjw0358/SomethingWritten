...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr bgcolor="#ffffff">
	<td width="230" colspan="2" valign="top" bgcolor="#a4c2c2">&nbsp;<img src="/image/star.jpg" alt="Home Page Image" width="227" height="196" border="0" />
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageName"><p><a href="about.html"></a><img src="/image/shuijinpopo.jpg" width="120" height="120" /></p></td>
		</tr>

		<tr>
		<td class="bodyText">
		<p>&nbsp;</p>
		<p>专业塔罗预测，爱情、事业、财运、各种让您无措的难题，塔罗牌会告诉你答案。</p>
		<p>预测地址：<a href="http://shop36960977.taobao.com/" target="_blank">http://shop36960977.taobao.com/</a><br />
		  洞悉前程，因势利导，掌握命运吧！</p>
		<p>&nbsp;</p>
		<br />		</td>
		</tr>
