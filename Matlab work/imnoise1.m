function b = imnoise1(varargin)   %≤¥À…‘Î…˘–ﬁ∏ƒ±æ
...
%   Class Support
%   -------------
%   I can be uint8, uint16, double, int16, or single.?The output image J
%   has the same class as I.  If I has more than two dimensions it is treated
...
%   $Revision: 5.20.4.4 $  $Date: 2004/08/10 01:40:22 $
  ...
  switch code
   ...
   case 'poisson' % Poisson noise
    ...
    if (~isempty(idx1))
      b(idx1)=round( a(idx1)+ (sqrt(a(idx1)).*randn(size(idx1)))/p3 );
    end
