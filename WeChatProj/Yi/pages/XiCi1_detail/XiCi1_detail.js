// pages/XiCi1_detail/XiCi1_detail.js
var gChapter='';
...
Page({
  ...
  /*
  touchStartInXiCi1Page: function (e) {
  ...
  touchEndInXiCi1Page: function (e) {
      ...
      if (touchMove - touchDot <= -40 && time < 10 && flag_hd == true) {
        ...
        wx.redirectTo({
          url: '../XiCi1_detail/XiCi1_detail?chapter=' + gChapterIndexNext
        })
      }
      // 向右滑动   
  ...
  */
  ...
  touchMoveInXiCi1Page: function (event) {
  ...
  //滑动开始事件
  touchStartInXiCi1Page: function (event) {
  ...
  //滑动结束事件
  touchEndInXiCi1Page: function (event) {
