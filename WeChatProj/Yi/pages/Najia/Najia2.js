...
ReturnGanZhi:function(nyear,yyear,nmonth,nday,ydate){
 ...
 // console.error('ZhiYue', ZhiYue)
  ...
  GetPPstyle:function(){
    ...
    var default_v = this.data.stlye_value    
    return default_v
  },
  ...
  else
  {
    ...
    var default_gua = this.data.y6Index + this.data.y5Index + this.data.y4Index + this.data.y3Index + this.data.y2Index + this.data.y1Index;
      ...
      wx.navigateTo({
        url: '../Najia/NajiaPaiPan?&dateIndex=' + StrDate + '&timeIndex=' + time_index + '&YLymd=' + StrYinLi + '&ganzhiGrp=' + nGanZhi + '&qigua_flag=' + '1' + '&defaultGua=' + default_gua + '&ppflag=' + ppflag + '&xiadong_day=' + xia_dong_day + '&xuanguaFlag=' + qgstyle 
      })
    ...
    {
      wx.navigateTo({
        url: '../Najia/NajiaPaiPan?&dateIndex=' + StrDate + '&timeIndex=' + time_index + '&YLymd=' + StrYinLi + '&ganzhiGrp=' + nGanZhi + '&qigua_flag=' + '1' + '&ppflag=' + ppflag + '&xiadong_day=' + xia_dong_day + '&xuanguaFlag=' + qgstyle + '&benIndex=' + index1 + '&bianIndex=' + index2
      })
    }
